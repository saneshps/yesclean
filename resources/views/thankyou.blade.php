...
@section('meta')
@if($slug!=""||$slug!="thankyou")
<title>{{$supplier->meta_title!=""?$supplier->meta_title:'Deals'}}</title>
<meta name="keywords" content="{{$supplier->keywords!=""?$supplier->keywords:'Special Offers'}}">
<meta name="description" content="{{$supplier->meta_description!=""?$supplier->meta_description:'Special Offers'}}">
<!-- canonical -->
...
@endsection
@push('style')
<link rel="stylesheet" href="{{asset('frontend/css/products.css')}}" fetchpriority="high">
...
@if($slug!=""||$slug!="thankyou")
<img class="banner-desktop lozad asyncImage"  src="{{(file_exists($supplier->banner_url)||$supplier->banner_url!=" ")?env('APP_ADMIN_URL').$supplier->banner_url:asset('assets/img/banner.jpeg')}}" data-src="{{(file_exists($supplier->banner_url)||$supplier->banner_url!="")?env('APP_ADMIN_URL').$supplier->banner_url:asset('assets/img/banner.jpeg')}}" alt=""  fetchpriority="high">  
@else 
	<img class="banner-desktop lozad asyncImage"  src="{{asset('assets/img/banner.jpeg')}}" data-src="{{asset('assets/img/banner.jpeg')}}" alt=""  fetchpriority="high"> 
@endif	
<div class="banner-mobile">
@if($slug!=""||$slug!="thankyou")
            <img  src="{{(file_exists($supplier->banner_mobile_url)||$supplier->banner_mobile_url!=" ")?env('APP_ADMIN_URL').$supplier->banner_mobile_url:asset('assets/img/banner-mobile.jpg')}}" data-src="{{(file_exists($supplier->banner_mobile_url)||$supplier->banner_mobile_url!="")?env('APP_ADMIN_URL').$supplier->banner_mobile_url:asset('assets/img/banner-mobile.jpg')}}" class="lozad asyncImage" alt="banner"  fetchpriority="high">
@else 
	 <img  src="{{asset('assets/img/banner-mobile.jpg')}}" data-src="{{asset('assets/img/banner-mobile.jpg')}}" class="lozad asyncImage" alt="banner"  fetchpriority="high">
@endif	
</div>
...
<div class="alert alert-success alert-block">
                                        ...
                                        <strong>Thank you for sending interest. Our team will contact you soon</strong>
</div>
</div>
<!-- =====================
              BANNER END
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-6 pp">
                <div class="product-first-boxes">
				 ...
				 <div class="pro-box-img">
                    <img src="{{env('APP_ADMIN_URL')}}{{$deal->pimage}}" data-src="{{env('APP_ADMIN_URL')}}{{$deal->pimage}}" alt="{{$deal->title!=""?$deal->title:$deal->pname}}" class="asyncImage"  fetchpriority="high">
				</div>	
					  <h4 class="country-twt">Made in {{$deal->cname}}</h4>
                      <a href="{{route('product',$deal->pslug)}}" target="_blank" class="title"><h2>{{($deal->title!=""?$deal->title:$deal->pname)}} </h2></a>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="how-it-work">
                        <div class="how-it-work-image">
                            <img class="lozad" data-src="{{asset('assets/img/Browse-Select.png')}}" src="{{asset('assets/img/Browse-Select.png')}}" alt="Browse & Select Your Cleaning Machinery"  fetchpriority="high">
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="how-it-work">
                        <div class="how-it-work-image">
                            <img class="lozad" data-src="{{asset('assets/img/Submit-your-details.png')}}" src="{{asset('assets/img/Submit-your-details.png')}}" alt="Submit your details"  fetchpriority="high">
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="how-it-work">
                        <div class="how-it-work-image">
                            <img  class="lozad" data-src="{{asset('assets/img/team-will-contact.png')}}" src="{{asset('assets/img/team-will-contact.png')}}" alt="team will contact"  fetchpriority="high">
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="product-features-box">
                        <img class="lozad" data-src="{{asset('assets/img/high-quality.png')}}"  src="{{asset('assets/img/high-quality.png')}}" alt="High quality European made Machinery"  fetchpriority="high">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="product-features-box">
                        <img class="lozad" data-src="{{asset('assets/img/warranty.png')}}" src="{{asset('assets/img/warranty.png')}}" alt="12 Months Warranty"  fetchpriority="high">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="product-features-box">
                        <img class="lozad" data-src="{{asset('assets/img/technicians.png')}}" src="{{asset('assets/img/technicians.png')}}" alt="⁠Service by trained technicians"  fetchpriority="high">
...
<script>
    $(document).ready(function() {
        ...
        $(".csubmit").on("click", function() {
			...
			if(slug==null||slug=='thankyou'){
				var data_url = '/deals/thankyou';
				
			} else if(slug==slug||status=='thankyou') {
				var data_url = '/deals/' + slug + '/' + status;
            } else if(slug=='thankyou'){
				var data_url = '/deals/' + slug;
			}				
