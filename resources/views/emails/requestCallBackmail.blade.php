...
<head>
  <meta charset="UTF-8">
  <title>Request Call Back for {{ $data['product_name'] }} </title>
          ...
          <!-- Content Start -->
	        <table class="table" style="width:600px!important;margin:0 auto; padding-bottom: 20px;">
				<tbody>
				   <tr>
				      <td>
	        		 <p style="font-size: 18px;font-weight: 600;">You have received a request call back for {{ $data['product_name'] }} from Yesclean</p>
        <ul style="
    background: white;
    list-style: none;
     padding: 16px;
