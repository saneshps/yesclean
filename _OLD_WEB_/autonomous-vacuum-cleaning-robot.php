...
<head>
  ...
  <title>Autonomous Vacuum Cleaning Robot | Sweeper Vacuum Robot | Yes Clean UAE</title>
  ...
  <meta name="description" content="Get autonomous vacuum cleaners for advanced cleaning. Sweeper vacuum robot for the most modern cleaning machines and cleaning equipment..">


         <!-- canonical -->
 <link href="https://www.yesclean.ae/autonomous-vacuum-cleaning-robot.php" rel="canonical">
      <!--// canonical -->
          ...
          <div class="slides">
            ...
            <div class="slide is-active ">
              ...
              <div class="image-container">
                ...
                <img src="img/autonomous/autonomous-banner.jpg" alt="Road Sweepers" class="image" />
            ...
            <div class="slide">
              ...
              <div class="image-container">
                ...
                <img src="img/autonomous/autonomous-banner-1.jpg" alt="Road Sweepers in UAE" class="image" />
            ...
            <div class="caption1">
              <div class="title1">
                <h1> Autonomous Vacuum Cleaning Robot </h1>
              </div>
              <div class="text-inn">
                <p> Vacuum Cleaning Robot with Fleet Management Software </p>
              </div>
            </div>
  ...
  <section class="about-cont">
    ...
    border-color: #017ac9;
        ...
        <div class="col-md-3 col-sm-12">
          ...
          <div class="expert">
            ...
            <div class="download">
              ...
              <p>
                <a href="pdf/S170-Navi-Catalogue.pdf" target="blank">

                  <i class="demo-icon icon-file-pdf">&#xf1c1;</i>

                  S170 Navi Catalogue </a>
              </p>
        ...
        <div class="col-md-9 col-sm-12">
          ...
          <h2 style="text-transform: uppercase;" id="product-tittle"> Vacuum Cleaning Robot with Fleet management </h2>

          <p> Professional Vacuum Cleaning Robot with docking station and battery, optional with fleet management.
          </p>


          <p> A unique vacuum cleaning robot concept specially developed for professional use on hard floors and short pile carpets up to 300m2/per unit. It cleans independently according to a systematic algorithm (no chaotic random cleaning) and intelligently adapts to changes in its environment.
            The docking station charges the battery and empties the dust tank fully automated. Once charging/dust emptying is complete, the robot continues cleaning at the previous position.

          </p>


          <p> Thanks to the docking station with suction function, there is no need for daily dust tank emptying, which significantly reduces the maintenance workload.
          </p>


          <p> The roller brush with rubber blades and brushes helps to collect even deep-seated dirt. The built-in HEPA filter and regular vacuuming help to reduce the dust pollution in your
            facilities and thus increase the well-being of your employees and customers. </p>


          <p> The Vacuum Cleaning Robot cleans on-demand or on schedule, 24/7, completely autonomously.
            FieldBots fleet management makes it possible to centrally control several hundred robots.
          </p>
          <p> The Vacuum Cleaning Robot works perfectly in Hotels, Hospitals, Offices, Hallways,
            Wardrobes, Retails Spaces, Nursing Homes, Rooms, Entrance areas and many more.
          </p>
          ...
          <div class="row top dry-vacuum">
            ...
            <div class="col-md-6">
              ...
              <a data-fancybox="gallery" href="./img/autonomous-vacuum-cleaning.jpg">
                <img src="./img/autonomous-vacuum-cleaning.jpg" alt="VS4">
              </a>

            </div>

            <div class="col-md-6">
              <h4 class="col-md-12 autonomous-head"> Software </h4>

              <h5> Control and fleet management by FieldBots. </h5>
              <ul class="autonomous-vaccum">
                <li> <i class="fas fa-caret-right"></i> Planner + group start </li>
                <li> <i class="fas fa-caret-right"></i> Maintenance view </li>
                <li> <i class="fas fa-caret-right"></i> Statistics and reports </li>
                <li> <i class="fas fa-caret-right"></i> For mobile, tablet and PC </li>
              </ul>
