...
';
  ...
  if (mail('paulgeorge4567@gmail.com', 'Express Interest', $message, $header)) {
...
<head>
  ...
  <title>Commercial Floor Cleaning Robot | Autonomous Sweeper - YES Clean UAE</title>
          ...
          <div class="slides">
            ...
            <div class="slide is-active ">
              ...
              <div class="image-container">
                ...
                <img src="img/autonomous-sweeper-ban1.png" alt="autonomous sweeper" class="image" />
            ...
            <div class="slide">
              ...
              <div class="image-container">
                ...
                <img src="img/autonomous-sweeper-ban2.png" alt="floor cleaning robot
...
" class="image" />
            ...
            <div class="slide">
              ...
              <div class="image-container">
                ...
                <img src="img/autonomous-sweeper-ban3.png" alt="robotic scrubber drier
...
" class="image" />
            ...
            <div class="slide">
              ...
              <div class="image-container">
                ...
                <img src="img/autonomous-sweeper-ban5.png" alt="robotic sweeper
...
" class="image" />
            ...
            <div class="slide">
              ...
              <div class="image-container">
                ...
                <img src="img/autonomous-sweeper-ban7.png" alt="automatic floor cleaning machine
...
" class="image" />
            ...
            <div class="slide">
              ...
              <div class="image-container">
                ...
                <img src="img/autonomous-sweeper-ban9.png" alt="robotic cleaning machine
  ...
  <section class="about-cont">
    ...
    border-color: #017ac9;
        ...
        <div class="col-md-9  col-sm-12">
          ...
          <h2 style="text-transform: uppercase;" id="product-tittle">FLOOR CLEANING ROBOT</h2>
          <p> Commercial floor cleaning robots that are made from top-notch swiss technology and
            Artificial Intelligence. An autonomous sweeper that works intelligently and independently
            without a driver and is capable to avoid any obstacle in their sweeping area This autonomous
            floor cleaning robot is also capable to empty the particles collected in their tank automatically.
          </p>

          <p>Cleanfix designs and manufactures floor cleaning robots for professional use. A top priority is to offer the highest quality Swiss products, supported by excellent service and customer proximity. Due to constant innovation, Cleanfix has been able to gain a global presence and ensure clean buildings in 85 countries.</p>

          <p>Cleanfix has led this market segment with its knowledge and experience of autonomous sweeping robots since 2008. Among robotic scrubber-driers, Cleanfix is the No. 1 brand in the world.</p>

          <p>Typically, a floor cleaning robot or cleaning robot navigates by itself, its route using complex algorithms that calculate each movement with the help of its sensors and distance measuring lasers, which provide the system with an accurate map covering every point of the target area.</p>

          <p>With models RA 660 Navi & RA660 Navi XL, the robotic scrubber can be used in areas where hygiene and cost-efficiency are priorities. Featuring a patented navigation system, three cleaning brushes (or pads), and a vacuum unit, RA 660 Navi scrubs and vacuums autonomously and highly efficiently whenever you want, even in crowded areas.</p>

          <p>In collaboration with KUKA and Carla Connect technology, RA660 Navi XL has developed an automated 24/7 power charging station.</p>
          ...
          <p>It is developed with an intelligent algorithm for cleaning, this tool can clean up to 1500m2 per hour.

            A unique shape with an intelligent design that lets it move in tight spaces without missing a spot.

            Simple setup and intuitive user interface. You never miss any reports since you're always up to date.
          ...
          <div class="row top">
            ...
            <div class="col-md-6  col-sm-12">
              ...
              <iframe width="100%" height="315" src="https://www.youtube.com/embed/B8Wogm-Z_5E" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

            </div>

            <div class="col-md-6 col-sm-12">

              <iframe width="100%" height="315" src="https://www.youtube.com/embed/oShwxfOuBwg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
