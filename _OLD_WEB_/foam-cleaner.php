...
<head>
  ...
  <title>Foam Cleaning Machine | Foam Cleaner - YES Clean UAE</title>

  <link rel="shortcut icon" href="img/favicon.png">

  <meta charset="utf-8">

  <meta name="keywords" content="Foam Cleaning Machine, Foam Cleaning Machines in uae, Foam Cleaner, Foam Cleaner in UAE, Foam Cleaner euipment">

  <meta name="viewport" content="width=device-width, initial-scale=1">

  <meta name="description" content="Select the best foam cleaning machine from YES Clean. From YES, you will be able to find the one you prefer among the range of foam cleaning machines listed.">

  <!-- canonical -->
  <link href="https://www.yesclean.ae/foam-cleaner.php" rel="canonical">
  <!--// canonical -->
          ...
          <div class="slides">
            ...
            <div class="slide is-active ">
              ...
              <div class="image-container">
                ...
                <img src="img/foam-cleaner-banner.jpg" alt="foam-cleaner" class="image" />
            ...
            <div class="slide">
              ...
              <div class="image-container">
                ...
                <img src="img/form-cleaner.jpg" alt="Foam Cleaning machine" class="image" />
            ...
            <div class="caption1">
              ...
              <div class="text-inn">
                ...
                <p>Foam Cleaner Foam machine to Clean & Sanitize</p>
  ...
  <section class="about-cont">
    ...
    border-color: #017ac9;
        ...
        <div class="col-md-9 col-sm-12">
          ...
          <h2 style="text-transform: uppercase;" id="product-tittle"> Foam Cleaner </h2>

          <p> The best cleaning companion for your food industry. Foam Cleaning machines that are
            perfectly designed to produce controllable and consistent foam quality with the help of cleaning
            chemicals. Most versatile and durable Foam cleaning machine with the quality of any
            air-operated system. They are capable of long throws and can easily reach ceilings and tall
            equipment like kettles, food trucks, walls, tanks, and trucks. Most of our customers are based in
            restaurants, food processing facilities, and breweries.
          </p>

          <p> The Foam Cleaners are perfect to clean and sanitize public restrooms, by foaming, rinsing all surfaces and vacuuming, using a single machine. The Foam Cleaners ensures an extended chemical action on the dirt and bacteria and is therefore ideal for many places which need an heavy duty action. The Foam Cleaner can also be used as a wet vacuum cleaner, fresh water and carpet cleaning machine. </p>


          <p> The system boasts of high pressure pump delivering the either foam or detergent (individually controlled by valves). The same machine can be used for foam cleaning as well as sanitization. </p>
          ...
          <div class="row top dry-vacuum">
            ...
            <div class="col-xl-3 col-lg-3 col-md-4 col-6">
              <img src="img/SC1250-Foam.jpg" class="img-responsive" alt="Foam Cleaning equipment">
              <p>SC1250 Foam</p>
            </div>
            <!--// 1 -->
