...
<head>
  ...
  <title>Wet And Dry Vacuum Cleaner | Cleaning Equipments | Yes Clean UAE</title>
  ...
  <meta name="description" content="Wide range of wet & dry vacuum cleaners in UAE. Quality vacuum cleaners from YES Clean handle liquids as well as the usual dust and dry materials you'd expect.">
          ...
          <div class="slides">
            ...
            <div class="slide is-active ">
              ...
              <div class="image-container">
                ...
                <img src="img/cleaning-machines2.png" alt="Wet and Dry Vacuum Cleaners" class="image" />
            ...
            <div class="slide">
              ...
              <div class="image-container">
                ...
                <img src="img/cleaning-machines6.png" alt="Wet and Dry Vacuum Cleaners in UAE" class="image" />
            ...
            <div class="caption1">
              ...
              <div class="text-inn">
                <p>Wet & Dry Vacuum Cleaners even suitable for foam extraction</p>
              </div>
            </div>
  ...
  <section class="about-cont">
    ...
    border-color: #017ac9;
        ...
        <div class="col-md-9 col-sm-12">
          ...
          <h2 style="text-transform: uppercase;" id="product-tittle"> Wet & Dry Vacuum Cleaner </h2>

          <p> These Wet and Dry Vacuum Cleaners are Robust, powerful, and maneuverable at a low noise level. Also, these
            Vacuum Cleaners help to clean household and industries. The strong suction power characterizes these extremely handy and compact Vacuum Cleaners. The Vacuum Cleaners are extremely user – friendly model with ergonomic and multifunctional handle.
          </p>


          <p> Combined with special accessories, the vacuum cleaners are ideal for day-to-day cleaning activities, carpet vacuuming, floor cleaning, entrance mat cleaning, curtain, bed and other upholstery cleaning, wet floor cleaning to handle any spillages. </p>


          <p> Available as Dry Vacuum Cleaner and Wet & Dry Vacuum Cleaner </p>


          <p> Even the most stubborn dirt can be removed with considerably less detergent and enables effortless and efficient work. In addition, the environment is less polluted and sanitized. </p>
          ...
          <div class="row top dry-vacuum">
            ...
            <div class="col-xl-3 col-lg-3 col-md-4 col-6">
              <img src="img/dry-vacuum/S10.jpg" class="img-responsive" alt="Dry Vacuum Cleaners">
              <p>S10</p>
            </div>
            <!--// 1 -->
            ...
            <!-- 1 -->
            <div class="col-xl-3 col-lg-3 col-md-4 col-6">
              <img src="img/dry-vacuum/s10-plus.jpg" class="img-responsive" alt="Wet Vacuum Cleaners">
              <p>S10 plus</p>
            </div>
            <!--// 1 -->
            ...
            <!-- 1 -->
            <div class="col-xl-3 col-lg-3 col-md-4 col-6">
              <img src="img/dry-vacuum/s10plus-hepa.jpg" class="img-responsive" alt="Wet and Dry Vacuum Cleaner">
              <p>S10 plus HEPA</p>
            </div>
            <!--// 1 -->
            ...
            <!-- 1 -->
            <div class="col-xl-3 col-lg-3 col-md-4 col-6">
              <img src="img/dry-vacuum/s10plus-sl-total-gerade.jpg" class="img-responsive" alt="Dry Vacuum Cleaner">
              <p>S10 plus SL</p>
            </div>
            <!--// 1 -->
            ...
            <!-- 1 -->
            <div class="col-xl-3 col-lg-3 col-md-4 col-6">
              <img src="img/dry-vacuum/s08-total.jpg" class="img-responsive" alt="wet vacuum cleaners">
              <p>S08 </p>
            </div>
            <!--// 1 -->
            ...
            <!-- 1 -->
            <div class="col-xl-3 col-lg-3 col-md-4 col-6">
              <img src="img/dry-vacuum/rs08b-total.jpg" class="img-responsive" alt="wet vacuum cleaner">
              <p>RS08B</p>
            </div>
            <!--// 1 -->
            ...
            <!-- 1 -->
            <div class="col-xl-3 col-lg-3 col-md-4 col-6">
              <img src="img/dry-vacuum/rs05silent_total-export.jpg" class="img-responsive" alt="Vacuum Cleaners">
              <p>RS05 Silent / 650 W</p>
            </div>
            <!--// 1 -->

            <!-- 1 -->
            <div class="col-xl-3 col-lg-3 col-md-4 col-6">
              <img src="img/dry-vacuum/S20-plus.jpg" class="img-responsive" alt="Wet and Dry Vacuum Cleaner in Dubai">
              <p>S20 Plus</p>
            </div>
            <!--// 1 -->
          ...
          <!--
        		<h2 style="text-transform: uppercase;" id="product-tittle"> Wet Vacuum Cleaner</h2>
      ...
      Ex laborum accusamus expedita, mollitia quo pariatur harum
       ea sapiente debitis, ullam laboriosam accusantium ipsam! Neque cupiditate ipsam,
        assumenda et doloribus voluptates.
      </p>
-->
          ...
          <div class="row top dry-vacuum">
            ...
            <!-- 1 -->
            <div class="col-xl-3 col-lg-3 col-md-4 col-6">
              <img src="img/wet-vacuum/SW20-plus.jpg" class="img-responsive" alt="Wet and Dry Vacuum Cleaners">
              <p>SW20 Plus</p>
            </div>
            <!--// 1 -->
            ...
            <!-- 1 -->
            <div class="col-xl-3 col-lg-3 col-md-4 col-6">
              <img src="img/wet-vacuum/SW21-Combi.jpg" class="img-responsive" alt="Wet and Dry Vacuum Cleaner in UAE">
              <p>SW21 Combi</p>
            </div>
            <!--// 1 -->
            ...
            <!-- 1 -->
            <div class="col-xl-3 col-lg-3 col-md-4 col-6">
              <img src="img/wet-vacuum/SW21-Aqua.jpg" class="img-responsive" alt="Wet and Dry Vacuum Cleaner in Dubai">
              <p>SW21 Aqua</p>
            </div>
            <!--// 1 -->
            ...
            <!-- 1 -->
            <div class="col-xl-3 col-lg-3 col-md-4 col-6">
              <img src="img/wet-vacuum/SW25-K.jpg" class="img-responsive" alt="Dry Vacuum Cleaner">
              <p>SW25 K </p>
            </div>
            <!--// 1 -->
            ...
            <!-- 1 -->
            <div class="col-xl-3 col-lg-3 col-md-4 col-6">
              <img src="img/wet-vacuum/SW22.jpg" class="img-responsive" alt="Wet and Dry Vacuum Cleaners in UAE">
              <p>SW22 </p>
            </div>
            <!--// 1 -->
            ...
            <!-- 1 -->
            <div class="col-xl-3 col-lg-3 col-md-4 col-6">
              <img src="img/wet-vacuum/SW20-plus.jpg" class="img-responsive" alt="Best Vacuum Cleaners">
              <p>RS08B</p>
            </div>
            <!--// 1 -->
            ...
            <!-- 1 -->
            <div class="col-xl-3 col-lg-3 col-md-4 col-6">
              <img src="img/wet-vacuum/SW35.jpg" class="img-responsive" alt="Best Vacuum Cleaner">
              <p>SW35</p>
            </div>
            <!--// 1 -->
            ...
            <!-- 1 -->
            <div class="col-xl-3 col-lg-3 col-md-4 col-6">
              <img src="img/wet-vacuum/SW60.jpg" class="img-responsive" alt="Best Vacuum Cleaners in UAE">
              <p>SW60</p>
            </div>
            <!--// 1 -->
          ...
          <!--
        		<h2 style="text-transform: uppercase;" id="product-tittle"> Steam Vacuum Cleaner </h2>
